...
public class LeapFrogDamped implements Solver{
	...
	{		
		...
		//help coefficients for the dragging
		double help1_coef = 1 - getLinearDragCoefficient * dt * 0.5 / (2 * getMass);
		double help2_coef = 1 + getLinearDragCoefficient * dt * 0.5 / (2 * getMass);
	...
	public void complete(Particle p, Force f, double dt)
	{
		...
		double help1_coef = 1 - getPrevLinearDragCoefficient * dt * 0.5 / (2 * getMass);
		double help2_coef = 1 + getPrevLinearDragCoefficient * dt * 0.5 / (2 * getMass);
